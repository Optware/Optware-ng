...
COMMON_CROSS_PACKAGES = \
	...
	cabextract calc calcurse catdoc ccxstream cdargs \
	cherokee chillispot chrpath classpath clamav clearsilver clips \
	...
	logrotate lookat loudmouth lrzsz lsof lua lynx lzo \
