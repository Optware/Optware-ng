...
#define MAILSPOOLDIR "%OPTWARE_TARGET_PREFIX%/var/spool/mail/"
#define SENDMAIL "%OPTWARE_TARGET_PREFIX%/sbin/sendmail"
#define DEFflagsendmail ""
#define CF_no_procmail_yet
#define buggy_SENDMAIL
#define defPATH "PATH=%OPTWARE_TARGET_PREFIX%/bin:$HOME/bin:/bin:/usr/bin"
#define defSPATH "PATH=%OPTWARE_TARGET_PREFIX%/bin:/bin:/usr/bin"
