...
PERL-DATE-MANIP_VERSION=5.44
PERL-DATE-MANIP_SOURCE=DateManip-$(PERL-DATE-MANIP_VERSION).tar.gz
PERL-DATE-MANIP_DIR=DateManip-$(PERL-DATE-MANIP_VERSION)
