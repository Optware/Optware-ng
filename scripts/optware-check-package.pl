...
#       OPTWARE_TARGET => `file binary`
        ...
        "slugos5be" => "32-bit MSB .* ARM",
        "slugos5le" => "32-bit LSB .* ARM",
        "angstrombe" => "32-bit MSB .* ARM",
        "angstromle" => "32-bit LSB .* ARM",
        "openwrt-ixp4xx" => "MSB .* ARM",
        "fsg3" => "MSB .* ARM",
        "fsg3v4" => "MSB .* ARM",
        "wl500g" => "MIPS",
        "dns323" => "32-bit LSB .* ARM",
        "ds101" => "MSB .* ARM",
        ...
        "cs04q3armel" => "32-bit LSB .* ARM",
        "cs05q1armel" => "32-bit LSB .* ARM",
        "cs05q3armel" => "32-bit LSB .* ARM",
        "cs06q3armel" => "32-bit LSB .* ARM",
        "cs08q1armel" => "32-bit LSB .* ARM",
        "dns323" => "32-bit LSB .* ARM",
        "shibby-tomato-arm" => "LSB .* ARM",
        "buildroot-armeabi" => "LSB .* ARM",
        "buildroot-armeabi-ng" => "LSB .* ARM",
        "buildroot-armv5eabi-ng" => "LSB .* ARM",
        "buildroot-armv5eabi-ng-legacy" => "LSB .* ARM",
        "buildroot-armeabihf" => "LSB .* ARM",
        "buildroot-i686" => "32-bit LSB .* Intel 80386",
        "buildroot-mipsel" => "MIPS",
        "buildroot-mipsel-ng" => "MIPS",
        "buildroot-ppc-603e" => "PowerPC or cisco 4500",
        "buildroot-x86_64" => "x86-64",
        "ct-ng-ppc-e500v2" => "PowerPC or cisco 4500",
        "syno-i686" => "32-bit LSB .* Intel 80386",
        "syno-e500" => "PowerPC or cisco 4500",
        "syno-x07" => "32-bit LSB .* ARM",
        "vt4" => "32-bit LSB .* ARM",
        "ddwrt" => "MIPS",
        "oleg" => "MIPS",
        "openwrt-brcm24" => "MIPS",
