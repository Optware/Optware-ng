...
#
# Binaries should be installed into $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/sbin or $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/etc/xextproto/...
# Documentation files should be installed in $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/doc/xextproto/...
# Daemon startup scripts should be installed in $(XEXTPROTO_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??xextproto
#
