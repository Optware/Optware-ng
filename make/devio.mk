...
#DEVIO_CONFFILES=$(TARGET_PREFIX)/etc/devio.conf $(TARGET_PREFIX)/etc/init.d/SXXdevio
...
#
# Binaries should be installed into $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/sbin or $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/etc/devio/...
# Documentation files should be installed in $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/doc/devio/...
# Daemon startup scripts should be installed in $(DEVIO_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??devio
#
