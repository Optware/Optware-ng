...
#
# Binaries should be installed into $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/sbin or $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/etc/xfixes/...
# Documentation files should be installed in $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/doc/xfixes/...
# Daemon startup scripts should be installed in $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??xfixes
#
...
$(XFIXES_IPK): $(XFIXES_BUILD_DIR)/.built
	...
	rm -f $(XFIXES_IPK_DIR)$(TARGET_PREFIX)/lib/*.la
