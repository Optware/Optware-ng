...
#TREE_CONFFILES=$(TARGET_PREFIX)/etc/tree.conf $(TARGET_PREFIX)/etc/init.d/SXXtree
...
#
# Binaries should be installed into $(TREE_IPK_DIR)$(TARGET_PREFIX)/sbin or $(TREE_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TREE_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(TREE_IPK_DIR)$(TARGET_PREFIX)/etc/tree/...
# Documentation files should be installed in $(TREE_IPK_DIR)$(TARGET_PREFIX)/doc/tree/...
# Daemon startup scripts should be installed in $(TREE_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??tree
#
...
$(TREE_IPK): $(TREE_BUILD_DIR)/.built
	...
	$(MAKE) -C $(TREE_BUILD_DIR) install \
		DESTDIR=$(TREE_IPK_DIR) prefix=$(TREE_IPK_DIR)$(TARGET_PREFIX)
	$(STRIP_COMMAND) $(TREE_IPK_DIR)$(TARGET_PREFIX)/bin/tree
