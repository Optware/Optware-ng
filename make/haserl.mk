...
#HASERL_CONFFILES=$(TARGET_PREFIX)/etc/haserl.conf $(TARGET_PREFIX)/etc/init.d/SXXhaserl
...
#
# Binaries should be installed into $(HASERL_IPK_DIR)$(TARGET_PREFIX)/sbin or $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HASERL_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(HASERL_IPK_DIR)$(TARGET_PREFIX)/etc/haserl/...
# Documentation files should be installed in $(HASERL_IPK_DIR)$(TARGET_PREFIX)/doc/haserl/...
# Daemon startup scripts should be installed in $(HASERL_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??haserl
#
...
$(HASERL_IPK): $(HASERL_BUILD_DIR)/.built
	...
	mv $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin/haserl $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin/haserl-with-lua
	$(INSTALL) $(HASERL_BUILD_DIR)/without-lua/src/haserl $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin/haserl-without-lua
	$(STRIP_COMMAND) $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin/haserl-without-lua
	cd $(HASERL_IPK_DIR)$(TARGET_PREFIX)/bin && ln -sf haserl-without-lua haserl
