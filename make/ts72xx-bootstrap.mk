...
$(TS72XX_BOOTSTRAP_IPK): $(TS72XX_BOOTSTRAP_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/sbin
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)/writeable/lib
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv
	$(INSTALL) -d $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/*crt* $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/lib* $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
	rm -f $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/libpthread.so
	rm -f $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/lib*.a
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/gconv/* $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv/
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/ldscripts/* $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts/
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/ldconfig $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/sbin
	$(INSTALL) -m 755 $(TS72XX_BOOTSTRAP_BUILD_DIR)/rc.optware $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc

	$(STRIP_COMMAND) $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/*.so
	$(STRIP_COMMAND) $(TS72XX_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/*.so.*
