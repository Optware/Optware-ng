...
PERL-NET-SERVER_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/R/RH/RHANDOM
...
$(DL_DIR)/$(PERL-NET-SERVER_SOURCE):
	$(WGET) -P $(@D) $(PERL-NET-SERVER_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-net-server-source: $(DL_DIR)/$(PERL-NET-SERVER_SOURCE) $(PERL-NET-SERVER_PATCHES)

$(PERL-NET-SERVER_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-NET-SERVER_SOURCE) $(PERL-NET-SERVER_PATCHES) make/perl-net-server.mk
...
$(PERL-NET-SERVER_IPK): $(PERL-NET-SERVER_BUILD_DIR)/.built
	...
	find $(PERL-NET-SERVER_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
