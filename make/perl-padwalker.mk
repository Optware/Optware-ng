...
PERL-PADWALKER_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/R/RO/ROBIN
...
$(DL_DIR)/$(PERL-PADWALKER_SOURCE):
	$(WGET) -P $(@D) $(PERL-PADWALKER_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-padwalker-source: $(DL_DIR)/$(PERL-PADWALKER_SOURCE) $(PERL-PADWALKER_PATCHES)

$(PERL-PADWALKER_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-PADWALKER_SOURCE) $(PERL-PADWALKER_PATCHES) make/perl-padwalker.mk
...
$(PERL-PADWALKER_IPK): $(PERL-PADWALKER_BUILD_DIR)/.built
	...
	find $(PERL-PADWALKER_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
