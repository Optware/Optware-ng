...
#CDPARANOIA_CONFFILES=$(TARGET_PREFIX)/etc/cdparanoia.conf $(TARGET_PREFIX)/etc/init.d/SXXcdparanoia
...
#
# Binaries should be installed into $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/sbin or $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/cdparanoia/...
# Documentation files should be installed in $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/doc/cdparanoia/...
# Daemon startup scripts should be installed in $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??cdparanoia
#
...
$(CDPARANOIA_IPK): $(CDPARANOIA_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/
	$(INSTALL) -m 644 $(CDPARANOIA_SOURCE_DIR)/cdparanoia.conf $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/cdparanoia.conf
	$(INSTALL) -d $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
	$(INSTALL) -m 755 $(CDPARANOIA_SOURCE_DIR)/rc.cdparanoia $(CDPARANOIA_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXcdparanoia
