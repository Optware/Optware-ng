...
PERL-CONVERT-TNEF_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/D/DO/DOUGW
...
PERL-CONVERT-TNEF_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-CONVERT-TNEF_SOURCE):
	$(WGET) -P $(@D) $(PERL-CONVERT-TNEF_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-convert-tnef-source: $(DL_DIR)/$(PERL-CONVERT-TNEF_SOURCE) $(PERL-CONVERT-TNEF_PATCHES)

$(PERL-CONVERT-TNEF_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CONVERT-TNEF_SOURCE) $(PERL-CONVERT-TNEF_PATCHES) make/perl-convert-tnef.mk
...
$(PERL-CONVERT-TNEF_IPK): $(PERL-CONVERT-TNEF_BUILD_DIR)/.built
	...
	find $(PERL-CONVERT-TNEF_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
