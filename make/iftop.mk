...
IFTOP_CONFFILES=$(TARGET_PREFIX)/etc/iftop.conf $(TARGET_PREFIX)/etc/init.d/SXXiftop
...
#
# Binaries should be installed into $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/sbin or $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/iftop/...
# Documentation files should be installed in $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/doc/iftop/...
# Daemon startup scripts should be installed in $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??iftop
#
...
$(IFTOP_IPK): $(IFTOP_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(IFTOP_SOURCE_DIR)/iftop.conf $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/iftop.conf
	$(INSTALL) -d $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/man/man8
	$(INSTALL) -m 644 $(IFTOP_BUILD_DIR)/iftop.8 $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/man/man8
#	$(INSTALL) -m 755 $(IFTOP_SOURCE_DIR)/rc.iftop $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXiftop
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(IFTOP_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXiftop
