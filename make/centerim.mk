...
#CENTERIM_CONFFILES=$(TARGET_PREFIX)/etc/centerim.conf $(TARGET_PREFIX)/etc/init.d/SXXcenterim
...
#
# Binaries should be installed into $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/sbin or $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/centerim/...
# Documentation files should be installed in $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/doc/centerim/...
# Daemon startup scripts should be installed in $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??centerim
#
...
#	$(INSTALL) -d $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(CENTERIM_SOURCE_DIR)/centerim.conf $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/centerim.conf
#	$(INSTALL) -d $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(CENTERIM_SOURCE_DIR)/rc.centerim $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXcenterim
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(CENTERIM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXcenterim
