...
#
MYSQL_CONNECTOR_ODBC_CPPFLAGS=-include$(MYSQL_CONNECTOR_ODBC_BUILD_DIR)/odbc_const.h
...
$(MYSQL_CONNECTOR_ODBC_BUILD_DIR)/.configured: $(DL_DIR)/$(MYSQL_CONNECTOR_ODBC_SOURCE) $(MYSQL_CONNECTOR_ODBC_PATCHES) make/mysql-connector-odbc.mk
	...
	(cd $(@D); \
		...
		-DMYSQL_CXXFLAGS="$(STAGING_CPPFLAGS) $(MYSQL_CONNECTOR_ODBC_CPPFLAGS)" \
...
$(MYSQL_CONNECTOR_ODBC_IPK): $(MYSQL_CONNECTOR_ODBC_BUILD_DIR)/.built
	...
	rm -rf $(MYSQL_CONNECTOR_ODBC_IPK_DIR)$(TARGET_PREFIX)/test
