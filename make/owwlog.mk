...
#OWWLOG_CONFFILES=$(TARGET_PREFIX)/etc/owwlog.conf $(TARGET_PREFIX)/etc/init.d/SXXowwlog
...
#
# Binaries should be installed into $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/sbin or $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/owwlog/...
# Documentation files should be installed in $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/doc/owwlog/...
# Daemon startup scripts should be installed in $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??owwlog
#
...
#	$(INSTALL) -d $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(OWWLOG_SOURCE_DIR)/owwlog.conf $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/owwlog.conf
#	$(INSTALL) -d $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(OWWLOG_SOURCE_DIR)/rc.owwlog $(OWWLOG_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXowwlog
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXowwlog
