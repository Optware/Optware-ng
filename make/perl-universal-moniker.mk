...
PERL-UNIVERSAL-MONIKER_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/K/KA/KASEI
...
PERL-UNIVERSAL-MONIKER_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-UNIVERSAL-MONIKER_SOURCE):
	$(WGET) -P $(@D) $(PERL-UNIVERSAL-MONIKER_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-universal-moniker-source: $(DL_DIR)/$(PERL-UNIVERSAL-MONIKER_SOURCE) $(PERL-UNIVERSAL-MONIKER_PATCHES)

$(PERL-UNIVERSAL-MONIKER_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-UNIVERSAL-MONIKER_SOURCE) $(PERL-UNIVERSAL-MONIKER_PATCHES) make/perl-universal-moniker.mk
	$(MAKE) perl-stage
...
$(PERL-UNIVERSAL-MONIKER_IPK): $(PERL-UNIVERSAL-MONIKER_BUILD_DIR)/.built
	...
	find $(PERL-UNIVERSAL-MONIKER_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
