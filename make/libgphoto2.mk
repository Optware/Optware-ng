...
# LIBGPHOTO2_CONFFILES=$(TARGET_PREFIX)/etc/libgphoto2.conf $(TARGET_PREFIX)/etc/init.d/SXXlibgphoto2
...
#
# Binaries should be installed into $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/libgphoto2/...
# Documentation files should be installed in $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/doc/libgphoto2/...
# Daemon startup scripts should be installed in $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libgphoto2
#
...
#	$(INSTALL) -d $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(LIBGPHOTO2_SOURCE_DIR)/libgphoto2.conf $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/libgphoto2.conf
#	$(INSTALL) -d $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(LIBGPHOTO2_SOURCE_DIR)/rc.libgphoto2 $(LIBGPHOTO2_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXlibgphoto2
