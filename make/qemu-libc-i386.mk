...
###########################################################
#
QEMU_LIBC_I386_SITE=$(CROSSTOOL_SITE)
QEMU_LIBC_I386_VERSION=$(QEMU_LIBC_I386_GLIBC_VERSION)
QEMU_LIBC_I386_SOURCE=$(CROSSTOOL_SOURCE)
QEMU_LIBC_I386_DIR=$(CROSSTOOL_DIR)
QEMU_LIBC_I386_UNZIP=$(CROSSTOOL_UNZIP)
...
#
QEMU_LIBC_I386_GCC_VERSION=3.4.2
QEMU_LIBC_I386_GLIBC_VERSION=2.3.3
QEMU_LIBC_I386_BINUTILS_VERSION=2.15
...
#
QEMU_LIBC_I386_BUILD_DIR=$(BUILD_DIR)/qemu-libc-i386
...
#
$(QEMU_LIBC_I386_BUILD_DIR)/.configured: $(DL_DIR)/$(QEMU_LIBC_I386_SOURCE) $(QEMU_LIBC_I386_PATCHES)
