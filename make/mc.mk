...
#  PKG_CONFIG_LIBDIR=staging$(TARGET_PREFIX)/lib/pkgconfig pkg-config --libs glib-2.0
#
...
#
# Binaries should be installed into $(MC_IPK_DIR)$(TARGET_PREFIX)/sbin or $(MC_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MC_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(MC_IPK_DIR)$(TARGET_PREFIX)/etc/mc/...
# Documentation files should be installed in $(MC_IPK_DIR)$(TARGET_PREFIX)/doc/mc/...
# Daemon startup scripts should be installed in $(MC_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??mc
#
