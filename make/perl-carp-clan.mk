...
PERL-CARP-CLAN_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/S/ST/STBEY
...
$(DL_DIR)/$(PERL-CARP-CLAN_SOURCE):
	$(WGET) -P $(@D) $(PERL-CARP-CLAN_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-carp-clan-source: $(DL_DIR)/$(PERL-CARP-CLAN_SOURCE) $(PERL-CARP-CLAN_PATCHES)

$(PERL-CARP-CLAN_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CARP-CLAN_SOURCE) $(PERL-CARP-CLAN_PATCHES) make/perl-carp-clan.mk
	$(MAKE) perl-stage
