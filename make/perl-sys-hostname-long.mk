...
PERL-SYS-HOSTNAME-LONG_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/S/SC/SCOTT
...
PERL-SYS-HOSTNAME-LONG_IPK_VERSION=3
...
$(DL_DIR)/$(PERL-SYS-HOSTNAME-LONG_SOURCE):
	$(WGET) -P $(@D) $(PERL-SYS-HOSTNAME-LONG_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-sys-hostname-long-source: $(DL_DIR)/$(PERL-SYS-HOSTNAME-LONG_SOURCE) $(PERL-SYS-HOSTNAME-LONG_PATCHES)

$(PERL-SYS-HOSTNAME-LONG_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-SYS-HOSTNAME-LONG_SOURCE) $(PERL-SYS-HOSTNAME-LONG_PATCHES) make/perl-sys-hostname-long.mk
...
$(PERL-SYS-HOSTNAME-LONG_IPK): $(PERL-SYS-HOSTNAME-LONG_BUILD_DIR)/.built
	...
	find $(PERL-SYS-HOSTNAME-LONG_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
	(cd $(PERL-SYS-HOSTNAME-LONG_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
		find . -name '*.so' -exec chmod +w {} \; ; \
		find . -name '*.so' -exec $(STRIP_COMMAND) {} \; ; \
		find . -name '*.so' -exec chmod -w {} \; ; \
	)
	find $(PERL-SYS-HOSTNAME-LONG_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
