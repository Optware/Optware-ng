...
#ND_CONFFILES=$(TARGET_PREFIX)/etc/nd.conf $(TARGET_PREFIX)/etc/init.d/SXXnd
...
#
# Binaries should be installed into $(ND_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ND_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ND_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ND_IPK_DIR)$(TARGET_PREFIX)/etc/nd/...
# Documentation files should be installed in $(ND_IPK_DIR)$(TARGET_PREFIX)/doc/nd/...
# Daemon startup scripts should be installed in $(ND_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??nd
#
