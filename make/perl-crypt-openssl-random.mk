...
PERL-CRYPT-OPENSSL-RANDOM_IPK_VERSION=2
...
$(PERL-CRYPT-OPENSSL-RANDOM_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CRYPT-OPENSSL-RANDOM_SOURCE) $(PERL-CRYPT-OPENSSL-RANDOM_PATCHES) make/perl-crypt-openssl-random.mk
	$(MAKE) openssl-stage
...
$(PERL-CRYPT-OPENSSL-RANDOM_IPK): $(PERL-CRYPT-OPENSSL-RANDOM_BUILD_DIR)/.built
	...
	find $(PERL-CRYPT-OPENSSL-RANDOM_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
