...
ifdef LIBSTDC++_USED
	$(INSTALL) -d $(LIBSTDC++_IPK_DIR)$(TARGET_PREFIX)/lib
	$(INSTALL) -m 644 $(LIBSTDC++_BUILD_DIR)/$(LIBSTDC++_LIBNAME_FULL) $(LIBSTDC++_IPK_DIR)$(TARGET_PREFIX)/lib
	(cd $(LIBSTDC++_IPK_DIR)$(TARGET_PREFIX)/lib; \
	 ln -s $(LIBSTDC++_LIBNAME_FULL) $(LIBSTDC++_LIBNAME); \
	 ln -s $(LIBSTDC++_LIBNAME_FULL) $(LIBSTDC++_LIBNAME_MAJOR) \
	)
	$(STRIP_COMMAND) $(LIBSTDC++_IPK_DIR)$(TARGET_PREFIX)/lib/*.$(SHLIB_EXT)
endif
