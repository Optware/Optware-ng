...
PERL-DBD-MYSQL_LDFLAGS=-L$(STAGING_LIB_DIR)/perl5/$(PERL_VERSION)/$(PERL_ARCH)/CORE -lperl -L$(STAGING_LIB_DIR)/mysql -lmysqlclient_r -Wl,-rpath=$(TARGET_PREFIX)/lib/mysql
