...
$(SDL-WEBOS_IPK): $(SDL-WEBOS_BUILD_DIR)/.built
	...
	mkdir -p $(SDL-WEBOS_IPK_DIR)$(TARGET_PREFIX)
	mv $(SDL-WEBOS_DEV_IPK_DIR)$(TARGET_PREFIX)/lib $(SDL-WEBOS_IPK_DIR)$(TARGET_PREFIX)
	rm -f $(SDL-WEBOS_IPK_DIR)$(TARGET_PREFIX)/lib/libSDL.la
	-$(STRIP_COMMAND) $(SDL-WEBOS_IPK_DIR)$(TARGET_PREFIX)/lib/*.so.*
