...
#
# Binaries should be installed into $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/etc/pthread-stubs/...
# Documentation files should be installed in $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/doc/pthread-stubs/...
# Daemon startup scripts should be installed in $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??pthread-stubs
#
...
#	$(INSTALL) -m 644 $(PTHREAD-STUBS_SOURCE_DIR)/postinst $(PTHREAD-STUBS_IPK_DIR)/CONTROL/postinst
	rm -f $(PTHREAD-STUBS_IPK_DIR)$(TARGET_PREFIX)/lib/*.la
