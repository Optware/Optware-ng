...
#NETRIK_CONFFILES=$(TARGET_PREFIX)/etc/netrik.conf $(TARGET_PREFIX)/etc/init.d/SXXnetrik
...
#
# Binaries should be installed into $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/sbin or $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/netrik/...
# Documentation files should be installed in $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/doc/netrik/...
# Daemon startup scripts should be installed in $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??netrik
#
...
#	$(INSTALL) -d $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(NETRIK_SOURCE_DIR)/netrik.conf $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/netrik.conf
#	$(INSTALL) -d $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(NETRIK_SOURCE_DIR)/rc.netrik $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXnetrik
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(NETRIK_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXnetrik
