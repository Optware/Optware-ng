...
#
# Binaries should be installed into $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/etc/textutils/...
# Documentation files should be installed in $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/doc/textutils/...
# Daemon startup scripts should be installed in $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??textutils
#
...
$(TEXTUTILS_IPK): $(TEXTUTILS_BUILD_DIR)/.built
	...
	rm -f $(TEXTUTILS_IPK_DIR)$(TARGET_PREFIX)/info/dir
