...
PERL-DIGEST-HMAC_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/G/GA/GAAS
PERL-DIGEST-HMAC_VERSION=1.03
...
$(DL_DIR)/$(PERL-DIGEST-HMAC_SOURCE):
	$(WGET) -P $(@D) $(PERL-DIGEST-HMAC_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-digest-hmac-source: $(DL_DIR)/$(PERL-DIGEST-HMAC_SOURCE) $(PERL-DIGEST-HMAC_PATCHES)

$(PERL-DIGEST-HMAC_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-DIGEST-HMAC_SOURCE) $(PERL-DIGEST-HMAC_PATCHES) make/perl-digest-hmac.mk
...
$(PERL-DIGEST-HMAC_IPK): $(PERL-DIGEST-HMAC_BUILD_DIR)/.built
	...
	find $(PERL-DIGEST-HMAC_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
