...
#DTACH_CONFFILES=$(TARGET_PREFIX)/etc/dtach.conf $(TARGET_PREFIX)/etc/init.d/SXXdtach
...
#
# Binaries should be installed into $(DTACH_IPK_DIR)$(TARGET_PREFIX)/sbin or $(DTACH_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DTACH_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(DTACH_IPK_DIR)$(TARGET_PREFIX)/etc/dtach/...
# Documentation files should be installed in $(DTACH_IPK_DIR)$(TARGET_PREFIX)/doc/dtach/...
# Daemon startup scripts should be installed in $(DTACH_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??dtach
#
...
#	$(MAKE) -C $(DTACH_BUILD_DIR) DESTDIR=$(DTACH_IPK_DIR) install-strip
	$(INSTALL) -d $(DTACH_IPK_DIR)$(TARGET_PREFIX)/bin
	$(INSTALL) $(DTACH_BUILD_DIR)/dtach $(DTACH_IPK_DIR)$(TARGET_PREFIX)/bin/
	$(STRIP_COMMAND) $(DTACH_IPK_DIR)$(TARGET_PREFIX)/bin/dtach
	$(INSTALL) -d $(DTACH_IPK_DIR)$(TARGET_PREFIX)/share/man/man1
	$(INSTALL) $(DTACH_BUILD_DIR)/dtach.1 $(DTACH_IPK_DIR)$(TARGET_PREFIX)/share/man/man1/
