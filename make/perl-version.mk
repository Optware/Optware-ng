...
PERL-VERSION_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/J/JP/JPEACOCK
...
$(DL_DIR)/$(PERL-VERSION_SOURCE):
	$(WGET) -P $(@D) $(PERL-VERSION_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-version-source: $(DL_DIR)/$(PERL-VERSION_SOURCE) $(PERL-VERSION_PATCHES)

$(PERL-VERSION_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-VERSION_SOURCE) $(PERL-VERSION_PATCHES) make/perl-version.mk
