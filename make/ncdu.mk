...
#NCDU_CONFFILES=$(TARGET_PREFIX)/etc/ncdu.conf $(TARGET_PREFIX)/etc/init.d/SXXncdu
...
#
# Binaries should be installed into $(NCDU_IPK_DIR)$(TARGET_PREFIX)/sbin or $(NCDU_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NCDU_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(NCDU_IPK_DIR)$(TARGET_PREFIX)/etc/ncdu/...
# Documentation files should be installed in $(NCDU_IPK_DIR)$(TARGET_PREFIX)/doc/ncdu/...
# Daemon startup scripts should be installed in $(NCDU_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??ncdu
#
