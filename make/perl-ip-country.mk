...
$(PERL-IP-COUNTRY_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-IP-COUNTRY_SOURCE) $(PERL-IP-COUNTRY_PATCHES) make/perl-ip-country.mk
	$(MAKE) openssl-stage
...
$(PERL-IP-COUNTRY_IPK): $(PERL-IP-COUNTRY_BUILD_DIR)/.built
	...
	find $(PERL-IP-COUNTRY_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
