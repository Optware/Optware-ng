...
PERL-TEMPLATE-TOOLKIT_IPK_VERSION=3
...
$(PERL-TEMPLATE-TOOLKIT_IPK): $(PERL-TEMPLATE-TOOLKIT_BUILD_DIR)/.built
	...
	find $(PERL-TEMPLATE-TOOLKIT_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
	(cd $(PERL-TEMPLATE-TOOLKIT_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
		find . -name '*.so' -exec chmod +w {} \; ; \
		find . -name '*.so' -exec $(STRIP_COMMAND) {} \; ; \
		find . -name '*.so' -exec chmod -w {} \; ; \
	)
	find $(PERL-TEMPLATE-TOOLKIT_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
