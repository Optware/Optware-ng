...
#
# Binaries should be installed into $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/etc/alac_decoder/...
# Documentation files should be installed in $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/doc/alac_decoder/...
# Daemon startup scripts should be installed in $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??alac_decoder
#
...
$(ALAC_DECODER_IPK): $(ALAC_DECODER_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/bin
	$(INSTALL) -m 755 $(ALAC_DECODER_BUILD_DIR)/alac $(ALAC_DECODER_IPK_DIR)$(TARGET_PREFIX)/bin/alac
