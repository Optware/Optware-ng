...
#PY-WEBHELPERS_CONFFILES=$(TARGET_PREFIX)/etc/py-webhelpers.conf $(TARGET_PREFIX)/etc/init.d/SXXpy-webhelpers
...
#
# Binaries should be installed into $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/etc/py-webhelpers/...
# Documentation files should be installed in $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/doc/py-webhelpers/...
# Daemon startup scripts should be installed in $(PY-WEBHELPERS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??py-webhelpers
#
...
$(PY25-WEBHELPERS_IPK): $(PY-WEBHELPERS_BUILD_DIR)/.built
	...
	(cd $(PY-WEBHELPERS_BUILD_DIR)/2.5; \
	    ...
	    --root=$(PY25-WEBHELPERS_IPK_DIR) --prefix=$(TARGET_PREFIX))
...
$(PY26-WEBHELPERS_IPK): $(PY-WEBHELPERS_BUILD_DIR)/.built
	...
	(cd $(PY-WEBHELPERS_BUILD_DIR)/2.6; \
	    ...
	    --root=$(PY26-WEBHELPERS_IPK_DIR) --prefix=$(TARGET_PREFIX))
