...
#
# Binaries should be installed into $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/etc/printproto/...
# Documentation files should be installed in $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/doc/printproto/...
# Daemon startup scripts should be installed in $(PRINTPROTO_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??printproto
#
