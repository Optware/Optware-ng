...
#
# Binaries should be installed into $(RECORDPROTO_IPK_DIR)/opt/sbin or $(RECORDPROTO_IPK_DIR)/opt/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(RECORDPROTO_IPK_DIR)/opt/{lib,include}
# Configuration files should be installed in $(RECORDPROTO_IPK_DIR)/opt/etc/recordproto/...
# Documentation files should be installed in $(RECORDPROTO_IPK_DIR)/opt/doc/recordproto/...
# Daemon startup scripts should be installed in $(RECORDPROTO_IPK_DIR)/opt/etc/init.d/S??recordproto
#
