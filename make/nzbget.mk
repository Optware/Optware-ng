...
#
# Binaries should be installed into $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/sbin or $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/etc/nzbget/...
# Documentation files should be installed in $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/doc/nzbget/...
# Daemon startup scripts should be installed in $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??nzbget
#
...
$(NZBGET_IPK): $(NZBGET_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/bin/nzbget
#	$(INSTALL) -d $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(NZBGET_SOURCE_DIR)/rc.nzbget $(NZBGET_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXnzbget
