...
#ASTERISK14_MOH_FREEPLAY_GSM_CONFFILES=$(TARGET_PREFIX)/etc/asterisk14-moh-freeplay-gsm.conf $(TARGET_PREFIX)/etc/init.d/SXXasterisk14-moh-freeplay-gsm
...
#
# Binaries should be installed into $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/etc/asterisk14-moh-freeplay-gsm/...
# Documentation files should be installed in $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/doc/asterisk14-moh-freeplay-gsm/...
# Daemon startup scripts should be installed in $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??asterisk14-moh-freeplay-gsm
#
...
$(ASTERISK14_MOH_FREEPLAY_GSM_IPK): $(ASTERISK14_MOH_FREEPLAY_GSM_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/moh
	$(INSTALL) -m 644 $(ASTERISK14_MOH_FREEPLAY_GSM_BUILD_DIR)/*gsm $(ASTERISK14_MOH_FREEPLAY_GSM_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/moh
