...
#SNORT_CONFFILES=$(TARGET_PREFIX)/etc/snort.conf $(TARGET_PREFIX)/etc/init.d/SXXsnort
...
#
# Binaries should be installed into $(SNORT_IPK_DIR)$(TARGET_PREFIX)/sbin or $(SNORT_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SNORT_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/snort/...
# Documentation files should be installed in $(SNORT_IPK_DIR)$(TARGET_PREFIX)/doc/snort/...
# Daemon startup scripts should be installed in $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??snort
#
...
#	$(INSTALL) -d $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(SNORT_SOURCE_DIR)/snort.conf $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/snort.conf
#	$(INSTALL) -d $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(SNORT_SOURCE_DIR)/rc.snort $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXsnort
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SNORT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXsnort
