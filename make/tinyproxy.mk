...
TINYPROXY_CONFFILES=$(TARGET_PREFIX)/etc/tinyproxy.conf
...
#
# Binaries should be installed into $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/sbin or $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/etc/tinyproxy/...
# Documentation files should be installed in $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/doc/tinyproxy/...
# Daemon startup scripts should be installed in $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??tinyproxy
#
...
$(TINYPROXY_IPK): $(TINYPROXY_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/share/doc/tinyproxy
	$(INSTALL) -m 644 $(TINYPROXY_BUILD_DIR)/[ACINRT]* $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/share/doc/tinyproxy
#	$(INSTALL) -d $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(TINYPROXY_SOURCE_DIR)/rc.tinyproxy $(TINYPROXY_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXtinyproxy
