...
GETTEXT_DEPENDS=libintl, libunistring, libcroco
LIBINTL_DEPENDS=
else
GETTEXT_DEPENDS=libintl, libunistring, libcroco, libiconv
...
ifeq (libiconv, $(filter libiconv, $(PACKAGES)))
	...
	$(MAKE) libunistring-stage libcroco-stage
