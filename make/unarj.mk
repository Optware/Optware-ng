...
$(UNARJ_IPK): $(UNARJ_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(UNARJ_IPK_DIR)$(TARGET_PREFIX)/bin
	$(INSTALL) -m 755 $(UNARJ_BUILD_DIR)/unarj $(UNARJ_IPK_DIR)$(TARGET_PREFIX)/bin
	$(STRIP_COMMAND) $(UNARJ_IPK_DIR)$(TARGET_PREFIX)/bin/unarj
