...
#ASTERISK14_EXTRA_SOUNDS_EN_G729_CONFFILES=$(TARGET_PREFIX)/etc/asterisk14-extra-sounds-en-g729.conf $(TARGET_PREFIX)/etc/init.d/SXXasterisk14-extra-sounds-en-g729
...
#
# Binaries should be installed into $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/etc/asterisk14-extra-sounds-en-g729/...
# Documentation files should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/doc/asterisk14-extra-sounds-en-g729/...
# Daemon startup scripts should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??asterisk14-extra-sounds-en-g729
#
...
$(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK): $(ASTERISK14_EXTRA_SOUNDS_EN_G729_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds
	$(INSTALL) -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_BUILD_DIR)/*.g729 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds
	$(INSTALL) -d $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/ha
	$(INSTALL) -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_BUILD_DIR)/ha/*.g729 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/ha
	$(INSTALL) -d $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/wx
	$(INSTALL) -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_BUILD_DIR)/wx/*.g729 $(ASTERISK14_EXTRA_SOUNDS_EN_G729_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/wx
