...
PERL-EMAIL-MESSAGEID_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/R/RJ/RJBS
PERL-EMAIL-MESSAGEID_VERSION=1.405
...
PERL-EMAIL-MESSAGEID_IPK_VERSION=3
...
$(PERL-EMAIL-MESSAGEID_IPK): $(PERL-EMAIL-MESSAGEID_BUILD_DIR)/.built
	...
	find $(PERL-EMAIL-MESSAGEID_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
