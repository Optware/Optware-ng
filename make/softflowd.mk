...
#SOFTFLOWD_CONFFILES=$(TARGET_PREFIX)/etc/softflowd.conf $(TARGET_PREFIX)/etc/init.d/SXXsoftflowd
...
#
# Binaries should be installed into $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/sbin or $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/etc/softflowd/...
# Documentation files should be installed in $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/doc/softflowd/...
# Daemon startup scripts should be installed in $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??softflowd
#
...
$(SOFTFLOWD_IPK): $(SOFTFLOWD_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SOFTFLOWD_IPK_DIR)$(TARGET_PREFIX)/sbin/*
