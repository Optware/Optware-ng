...
#
###########################################################
PERL-CLASS-DATA-INHERITABLE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/T/TM/TMTM
...
PERL-CLASS-DATA-INHERITABLE_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-CLASS-DATA-INHERITABLE_SOURCE):
	$(WGET) -P $(@D) $(PERL-CLASS-DATA-INHERITABLE_SITE)/$(@F) || \
...
$(PERL-CLASS-DATA-INHERITABLE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CLASS-DATA-INHERITABLE_SOURCE) $(PERL-CLASS-DATA-INHERITABLE_PATCHES) make/perl-class-data-inheritable.mk
	$(MAKE) perl-stage
...
$(PERL-CLASS-DATA-INHERITABLE_IPK): $(PERL-CLASS-DATA-INHERITABLE_BUILD_DIR)/.built
	...
	find $(PERL-CLASS-DATA-INHERITABLE_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
