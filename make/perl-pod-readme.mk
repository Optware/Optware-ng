...
$(PERL-POD-README_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-POD-README_SOURCE) $(PERL-POD-README_PATCHES) make/perl-pod-readme.mk
	$(MAKE) perl-stage
...
$(PERL-POD-README_IPK): $(PERL-POD-README_BUILD_DIR)/.built
	...
	find $(PERL-POD-README_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
