...
$(PERL-CLONE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CLONE_SOURCE) $(PERL-CLONE_PATCHES) make/perl-clone.mk
	$(MAKE) perl-stage
...
$(PERL-CLONE_IPK): $(PERL-CLONE_BUILD_DIR)/.built
	...
	find $(PERL-CLONE_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
