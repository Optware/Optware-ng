...
#PY-HGSUBVERSION_CONFFILES=$(TARGET_PREFIX)/etc/py-hgsubversion.conf $(TARGET_PREFIX)/etc/init.d/SXXpy-hgsubversion
...
#
# Binaries should be installed into $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/etc/py-hgsubversion/...
# Documentation files should be installed in $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/doc/py-hgsubversion/...
# Daemon startup scripts should be installed in $(PY-HGSUBVERSION_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??py-hgsubversion
#
...
$(PY25-HGSUBVERSION_IPK): $(PY-HGSUBVERSION_BUILD_DIR)/.built
	...
	(cd $(PY-HGSUBVERSION_BUILD_DIR)/2.5; \
	    ...
	    --root=$(PY25-HGSUBVERSION_IPK_DIR) --prefix=$(TARGET_PREFIX); \
	)
...
$(PY26-HGSUBVERSION_IPK): $(PY-HGSUBVERSION_BUILD_DIR)/.built
	...
	(cd $(PY-HGSUBVERSION_BUILD_DIR)/2.6; \
	    ...
	    --root=$(PY26-HGSUBVERSION_IPK_DIR) --prefix=$(TARGET_PREFIX); \
	)
