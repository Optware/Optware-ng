...
PERL-WWW-MECHANIZE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/P/PE/PETDANCE
...
PERL-WWW-MECHANIZE_IPK_VERSION=4
...
$(PERL-WWW-MECHANIZE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-WWW-MECHANIZE_SOURCE) $(PERL-WWW-MECHANIZE_PATCHES) make/perl-www-mechanize.mk
