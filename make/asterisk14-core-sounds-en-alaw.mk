...
#ASTERISK14_CORE_SOUNDS_EN_ALAW_CONFFILES=$(TARGET_PREFIX)/etc/asterisk14-core-sounds-en-alaw.conf $(TARGET_PREFIX)/etc/init.d/SXXasterisk14-core-sounds-en-alaw
...
#
# Binaries should be installed into $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/etc/asterisk14-core-sounds-en-alaw/...
# Documentation files should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/doc/asterisk14-core-sounds-en-alaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??asterisk14-core-sounds-en-alaw
#
...
$(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK): $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/dictate
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/dictate/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/dictate
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/digits
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/digits/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/digits
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/followme
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/followme/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/followme
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/letters
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/letters/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/letters
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/phonetic
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/phonetic/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/phonetic
	$(INSTALL) -d $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/silence
	$(INSTALL) -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ALAW_BUILD_DIR)/silence/*.alaw $(ASTERISK14_CORE_SOUNDS_EN_ALAW_IPK_DIR)$(TARGET_PREFIX)/var/lib/asterisk/sounds/silence
