...
PERL-DIGEST-PERL-MD5_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/D/DE/DELTA
...
PERL-DIGEST-PERL-MD5_IPK_VERSION=3
...
$(DL_DIR)/$(PERL-DIGEST-PERL-MD5_SOURCE):
	$(WGET) -P $(@D) $(PERL-DIGEST-PERL-MD5_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-digest-perl-md5-source: $(DL_DIR)/$(PERL-DIGEST-PERL-MD5_SOURCE) $(PERL-DIGEST-PERL-MD5_PATCHES)

$(PERL-DIGEST-PERL-MD5_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-DIGEST-PERL-MD5_SOURCE) $(PERL-DIGEST-PERL-MD5_PATCHES) make/perl-digest-perl-md5.mk
...
$(PERL-DIGEST-PERL-MD5_IPK): $(PERL-DIGEST-PERL-MD5_BUILD_DIR)/.built
	...
	find $(PERL-DIGEST-PERL-MD5_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
	(cd $(PERL-DIGEST-PERL-MD5_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
		find . -name '*.so' -exec chmod +w {} \; ; \
		find . -name '*.so' -exec $(STRIP_COMMAND) {} \; ; \
		find . -name '*.so' -exec chmod -w {} \; ; \
	)
	find $(PERL-DIGEST-PERL-MD5_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
