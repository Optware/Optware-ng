...
#XCHAT_CONFFILES=$(TARGET_PREFIX)/etc/xchat.conf $(TARGET_PREFIX)/etc/init.d/SXXxchat
...
#
# Binaries should be installed into $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/sbin or $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/etc/xchat/...
# Documentation files should be installed in $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/doc/xchat/...
# Daemon startup scripts should be installed in $(XCHAT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??xchat
#
