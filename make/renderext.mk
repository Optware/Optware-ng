...
#
# Binaries should be installed into $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/sbin or $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/etc/renderext/...
# Documentation files should be installed in $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/doc/renderext/...
# Daemon startup scripts should be installed in $(RENDEREXT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??renderext
#
