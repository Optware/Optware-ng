...
$(PERL-HTML-PARSER_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-HTML-PARSER_SOURCE) $(PERL-HTML-PARSER_PATCHES) make/perl-html-parser.mk
...
$(PERL-HTML-PARSER_IPK): $(PERL-HTML-PARSER_BUILD_DIR)/.built
	...
	find $(PERL-HTML-PARSER_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
