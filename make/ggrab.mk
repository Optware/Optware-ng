...
#
# Binaries should be installed into $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/sbin or $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/ggrab/...
# Documentation files should be installed in $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/doc/ggrab/...
# Daemon startup scripts should be installed in $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??ggrab
#
...
#	$(MAKE) -C $(GGRAB_BUILD_DIR) DESTDIR=$(GGRAB_IPK_DIR) install-strip
	$(INSTALL) -d $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/bin
	$(INSTALL) -m 755 $(GGRAB_BUILD_DIR)/ggrab $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/bin/ggrab
	$(INSTALL) -m 755 $(GGRAB_BUILD_DIR)/sserver $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/bin/sserver
#	$(INSTALL) -d $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(GGRAB_SOURCE_DIR)/ggrab.conf $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/ggrab.conf
#	$(INSTALL) -d $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(GGRAB_SOURCE_DIR)/rc.ggrab $(GGRAB_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXggrab
