...
#
# Binaries should be installed into $(PRESENTPROTO_IPK_DIR)/opt/sbin or $(PRESENTPROTO_IPK_DIR)/opt/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PRESENTPROTO_IPK_DIR)/opt/{lib,include}
# Configuration files should be installed in $(PRESENTPROTO_IPK_DIR)/opt/etc/presentproto/...
# Documentation files should be installed in $(PRESENTPROTO_IPK_DIR)/opt/doc/presentproto/...
# Daemon startup scripts should be installed in $(PRESENTPROTO_IPK_DIR)/opt/etc/init.d/S??presentproto
#
