...
PERL-MODULE-PLUGGABLE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/S/SI/SIMONW
...
PERL-MODULE-PLUGGABLE_IPK_VERSION=3
...
$(PERL-MODULE-PLUGGABLE_IPK): $(PERL-MODULE-PLUGGABLE_BUILD_DIR)/.built
	...
	find $(PERL-MODULE-PLUGGABLE_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
