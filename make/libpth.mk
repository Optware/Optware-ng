...
#LIBPTH_CONFFILES=$(TARGET_PREFIX)/etc/libpth.conf $(TARGET_PREFIX)/etc/init.d/SXXlibpth
...
#
# Binaries should be installed into $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/etc/libpth/...
# Documentation files should be installed in $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/doc/libpth/...
# Daemon startup scripts should be installed in $(LIBPTH_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libpth
#
