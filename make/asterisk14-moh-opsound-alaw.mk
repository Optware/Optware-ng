...
#ASTERISK14_MOH_OPSOUND_ALAW_CONFFILES=/opt/etc/asterisk14-moh-opsound-alaw.conf /opt/etc/init.d/SXXasterisk14-moh-opsound-alaw
...
#
# Binaries should be installed into $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/sbin or $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/{lib,include}
# Configuration files should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/etc/asterisk14-moh-opsound-alaw/...
# Documentation files should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/doc/asterisk14-moh-opsound-alaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/etc/init.d/S??asterisk14-moh-opsound-alaw
#
...
$(ASTERISK14_MOH_OPSOUND_ALAW_IPK): $(ASTERISK14_MOH_OPSOUND_ALAW_BUILD_DIR)/.built
	...
	install -d $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/var/lib/asterisk/moh
	install -m 644 $(ASTERISK14_MOH_OPSOUND_ALAW_BUILD_DIR)/*alaw $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)/opt/var/lib/asterisk/moh
