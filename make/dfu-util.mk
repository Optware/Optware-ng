...
#
# Binaries should be installed into $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/sbin or $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/etc/dfu-util/...
# Documentation files should be installed in $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/doc/dfu-util/...
# Daemon startup scripts should be installed in $(DFU-UTIL_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??dfu-util
#
