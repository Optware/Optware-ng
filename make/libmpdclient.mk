...
#LIBMPDCLIENT_CONFFILES=$(TARGET_PREFIX)/etc/libmpdclient.conf $(TARGET_PREFIX)/etc/init.d/SXXlibmpdclient
...
#
# Binaries should be installed into $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/libmpdclient/...
# Documentation files should be installed in $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/doc/libmpdclient/...
# Daemon startup scripts should be installed in $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libmpdclient
#
...
#	$(INSTALL) -d $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(LIBMPDCLIENT_SOURCE_DIR)/libmpdclient.conf $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/libmpdclient.conf
#	$(INSTALL) -d $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(LIBMPDCLIENT_SOURCE_DIR)/rc.libmpdclient $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXlibmpdclient
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBMPDCLIENT_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXlibmpdclient
