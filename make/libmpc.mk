...
#
LIBMPC_SITE=ftp://ftp.gnu.org/gnu/mpc
...
LIBMPC_DESCRIPTION=Gnu Mpc is a C library for the arithmetic of complex numbers with arbitrarily high precision and correct rounding of the result.
LIBMPC_SECTION=misc
...
$(LIBMPC_BUILD_DIR)/.staged: $(LIBMPC_BUILD_DIR)/.built
	rm -f $@
	rm -f $(STAGING_LIB_DIR)/libmpc.*
	$(MAKE) -C $(@D) DESTDIR=$(STAGING_DIR) install
	rm -f $(STAGING_LIB_DIR)/libmpc.la
	touch $@
