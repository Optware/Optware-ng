...
PERL-MODULE-SIGNATURE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id//A/AU/AUTRIJUS
...
PERL-MODULE-SIGNATURE_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-MODULE-SIGNATURE_SOURCE):
	$(WGET) -P $(@D) $(PERL-MODULE-SIGNATURE_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-module-signature-source: $(DL_DIR)/$(PERL-MODULE-SIGNATURE_SOURCE) $(PERL-MODULE-SIGNATURE_PATCHES)

$(PERL-MODULE-SIGNATURE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-MODULE-SIGNATURE_SOURCE) $(PERL-MODULE-SIGNATURE_PATCHES) make/perl-module-signature.mk
