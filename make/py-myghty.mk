...
#PY-MYGHTY_CONFFILES=$(TARGET_PREFIX)/etc/py-myghty.conf $(TARGET_PREFIX)/etc/init.d/SXXpy-myghty
...
#
# Binaries should be installed into $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/etc/py-myghty/...
# Documentation files should be installed in $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/doc/py-myghty/...
# Daemon startup scripts should be installed in $(PY-MYGHTY_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??py-myghty
#
...
$(PY25-MYGHTY_IPK): $(PY-MYGHTY_BUILD_DIR)/.built
	...
	(cd $(PY-MYGHTY_BUILD_DIR)/2.5; \
	    ...
	    --root=$(PY25-MYGHTY_IPK_DIR) --prefix=$(TARGET_PREFIX))
...
$(PY26-MYGHTY_IPK): $(PY-MYGHTY_BUILD_DIR)/.built
	...
	(cd $(PY-MYGHTY_BUILD_DIR)/2.6; \
	    ...
	    --root=$(PY26-MYGHTY_IPK_DIR) --prefix=$(TARGET_PREFIX))
