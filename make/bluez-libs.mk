...
#BLUEZ-LIBS_CONFFILES=$(TARGET_PREFIX)/etc/bluez-libs.conf $(TARGET_PREFIX)/etc/init.d/SXXbluez-libs
...
#
# Binaries should be installed into $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/etc/bluez-libs/...
# Documentation files should be installed in $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/doc/bluez-libs/...
# Daemon startup scripts should be installed in $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??bluez-libs
#
...
$(BLUEZ-LIBS_IPK): $(BLUEZ-LIBS_BUILD_DIR)/.built
	...
	rm -f $(BLUEZ-LIBS_IPK_DIR)$(TARGET_PREFIX)/lib/libbluetooth.la
