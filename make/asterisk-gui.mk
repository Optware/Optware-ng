...
#
ASTERISK_GUI_SITE=http://svn.digium.com/svn/asterisk-gui
ASTERISK_GUI_VERSION=0.0.0
ASTERISK_GUI_SVN=http://svn.digium.com/svn/asterisk-gui/trunk
ASTERISK_GUI_SVN_REV=166
...
ASTERISK_GUI_MAINTAINER=NSLU2 Linux <nslu2-linux@yahoogroups.com>
ASTERISK_GUI_DESCRIPTION=Describe asterisk-gui here.
ASTERISK_GUI_SECTION=utils
ASTERISK_GUI_PRIORITY=optional
ASTERISK_GUI_DEPENDS=
...
#
# ASTERISK_GUI_CONFFILES should be a list of user-editable files
#ASTERISK_GUI_CONFFILES=/opt/etc/asterisk-gui.conf /opt/etc/init.d/SXXasterisk-gui

#
# ASTERISK_GUI_PATCHES should list any patches, in the the order in
# which they should be applied to the source code.
#
#ASTERISK_GUI_PATCHES=$(ASTERISK_GUI_SOURCE_DIR)/configure.patch
...
$(ASTERISK_GUI_BUILD_DIR)/.configured: $(DL_DIR)/$(ASTERISK_GUI_SOURCE) $(ASTERISK_GUI_PATCHES) make/asterisk-gui.mk
	...
	if test -n "$(ASTERISK_GUI_PATCHES)" ; \
		...
		patch -d $(BUILD_DIR)/$(ASTERISK_GUI_DIR) -p0 ; \
	fi
