...
$(LIBJBIGKIT_IPK): $(LIBJBIGKIT_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(LIBJBIGKIT_IPK_DIR)$(TARGET_PREFIX)/include
	cp $(LIBJBIGKIT_BUILD_DIR)/libjbig/*.h $(LIBJBIGKIT_IPK_DIR)$(TARGET_PREFIX)/include
	$(INSTALL) -d $(LIBJBIGKIT_IPK_DIR)$(TARGET_PREFIX)/lib
	cp $(LIBJBIGKIT_BUILD_DIR)/libjbig/*.so $(LIBJBIGKIT_IPK_DIR)$(TARGET_PREFIX)/lib
	$(STRIP_COMMAND) $(LIBJBIGKIT_IPK_DIR)$(TARGET_PREFIX)/lib/*.so
