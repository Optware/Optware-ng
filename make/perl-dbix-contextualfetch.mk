...
PERL-DBIX-CONTEXTUALFETCH_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/T/TM/TMTM
...
PERL-DBIX-CONTEXTUALFETCH_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-DBIX-CONTEXTUALFETCH_SOURCE):
	$(WGET) -P $(@D) $(PERL-DBIX-CONTEXTUALFETCH_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-dbix-contextualfetch-source: $(DL_DIR)/$(PERL-DBIX-CONTEXTUALFETCH_SOURCE) $(PERL-DBIX-CONTEXTUALFETCH_PATCHES)

$(PERL-DBIX-CONTEXTUALFETCH_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-DBIX-CONTEXTUALFETCH_SOURCE) $(PERL-DBIX-CONTEXTUALFETCH_PATCHES) make/perl-dbix-contextualfetch.mk
	$(MAKE) perl-dbi-stage
...
$(PERL-DBIX-CONTEXTUALFETCH_IPK): $(PERL-DBIX-CONTEXTUALFETCH_BUILD_DIR)/.built
	...
	find $(PERL-DBIX-CONTEXTUALFETCH_IPK_DIR)$(TARGET_PREFIX) -name 'perllocal.pod' -exec rm -f {} \;
	(cd $(PERL-DBIX-CONTEXTUALFETCH_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
		find . -name '*.so' -exec chmod +w {} \; ; \
		find . -name '*.so' -exec $(STRIP_COMMAND) {} \; ; \
		find . -name '*.so' -exec chmod -w {} \; ; \
	)
	find $(PERL-DBIX-CONTEXTUALFETCH_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
