...
#HNB_CONFFILES=$(TARGET_PREFIX)/etc/hnb.conf $(TARGET_PREFIX)/etc/init.d/SXXhnb
...
#
# Binaries should be installed into $(HNB_IPK_DIR)$(TARGET_PREFIX)/sbin or $(HNB_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HNB_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(HNB_IPK_DIR)$(TARGET_PREFIX)/etc/hnb/...
# Documentation files should be installed in $(HNB_IPK_DIR)$(TARGET_PREFIX)/doc/hnb/...
# Daemon startup scripts should be installed in $(HNB_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??hnb
#
