...
#LIBEXTRACTOR_CONFFILES=$(TARGET_PREFIX)/etc/libextractor.conf $(TARGET_PREFIX)/etc/init.d/SXXlibextractor
...
#
# Binaries should be installed into $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/libextractor/...
# Documentation files should be installed in $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/doc/libextractor/...
# Daemon startup scripts should be installed in $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libextractor
#
...
$(LIBEXTRACTOR_IPK): $(LIBEXTRACTOR_BUILD_DIR)/.built
	...
	rm -f $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/lib/libextractor.la $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/lib/libextractor/*.la
#	$(INSTALL) -d $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(LIBEXTRACTOR_SOURCE_DIR)/libextractor.conf $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/libextractor.conf
#	$(INSTALL) -d $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(LIBEXTRACTOR_SOURCE_DIR)/rc.libextractor $(LIBEXTRACTOR_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXlibextractor
