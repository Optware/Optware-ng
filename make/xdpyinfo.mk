...
#
XDPYINFO_CPPFLAGS=
XDPYINFO_LDFLAGS=-Wl,-rpath-link $(STAGING_LIB_DIR) -lX11
...
#
# Binaries should be installed into $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/sbin or $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/etc/xdpyinfo/...
# Documentation files should be installed in $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/doc/xdpyinfo/...
# Daemon startup scripts should be installed in $(XDPYINFO_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??xdpyinfo
#
