...
#
METALOG_SITE=http://belnet.dl.sourceforge.net/sourceforge/metalog/
METALOG_VERSION=0.7
...
$(METALOG_IPK): $(METALOG_BUILD_DIR)/.built
	...
	install -m 755 $(METALOG_SOURCE_DIR)/S01metalog $(METALOG_IPK_DIR)/opt/doc/S01metalog
