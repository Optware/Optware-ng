...
#HEXCURSE_CONFFILES=$(TARGET_PREFIX)/etc/hexcurse.conf $(TARGET_PREFIX)/etc/init.d/SXXhexcurse
...
#
# Binaries should be installed into $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/sbin or $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/etc/hexcurse/...
# Documentation files should be installed in $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/doc/hexcurse/...
# Daemon startup scripts should be installed in $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??hexcurse
#
...
$(HEXCURSE_IPK): $(HEXCURSE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(HEXCURSE_IPK_DIR)$(TARGET_PREFIX)/bin/hexcurse
