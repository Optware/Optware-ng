...
#TS209-KERNEL-MODULES_CONFFILES=$(TARGET_PREFIX)/etc/ts209-kernel-modules.conf $(TARGET_PREFIX)/etc/init.d/SXXts209-kernel-modules
...
#	$(MAKE) -C $(TS209-KERNEL-MODULES_BUILD_DIR) $(TS209-KERNEL-MODULES-FLAGS) clean
	$(INSTALL) -m 644  $(TS209-KERNEL-MODULES_SOURCE_DIR)/qnap_ts-209.cfg $(TS209-KERNEL-MODULES_BUILD_DIR)/.config;
...
#
# Binaries should be installed into $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/sbin or $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/etc/ts209-kernel-modules/...
# Documentation files should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/doc/ts209-kernel-modules/...
# Daemon startup scripts should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??ts209-kernel-modules
#
