...
$(PERL-LIBNET_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-LIBNET_SOURCE) $(PERL-LIBNET_PATCHES) make/perl-libnet.mk
	$(MAKE) perl-hostperl
...
$(PERL-LIBNET_IPK): $(PERL-LIBNET_BUILD_DIR)/.built
	...
	find $(PERL-LIBNET_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
