...
#LIBDLNA_CONFFILES=$(TARGET_PREFIX)/etc/libdlna.conf $(TARGET_PREFIX)/etc/init.d/SXXlibdlna
...
#
# Binaries should be installed into $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/etc/libdlna/...
# Documentation files should be installed in $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/doc/libdlna/...
# Daemon startup scripts should be installed in $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libdlna
#
...
$(LIBDLNA_IPK): $(LIBDLNA_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/lib/libdlna.so.$(LIBDLNA_VERSION)
	rm -f $(LIBDLNA_IPK_DIR)$(TARGET_PREFIX)/lib/libdlna.a
