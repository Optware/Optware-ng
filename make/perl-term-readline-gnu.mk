...
PERL-TERM-READLINE-GNU_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/H/HA/HAYASHI
...
PERL-TERM-READLINE-GNU_IPK_VERSION=3
...
$(PERL-TERM-READLINE-GNU_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-TERM-READLINE-GNU_SOURCE) $(PERL-TERM-READLINE-GNU_PATCHES) make/perl-term-readline-gnu.mk
...
$(PERL-TERM-READLINE-GNU_IPK): $(PERL-TERM-READLINE-GNU_BUILD_DIR)/.built
	...
	find $(PERL-TERM-READLINE-GNU_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
