...
#NEMESIS_CONFFILES=$(TARGET_PREFIX)/etc/nemesis.conf $(TARGET_PREFIX)/etc/init.d/SXXnemesis
...
#
# Binaries should be installed into $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/nemesis/...
# Documentation files should be installed in $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/doc/nemesis/...
# Daemon startup scripts should be installed in $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??nemesis
#
...
#	$(INSTALL) -d $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(NEMESIS_SOURCE_DIR)/nemesis.conf $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/nemesis.conf
#	$(INSTALL) -d $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(NEMESIS_SOURCE_DIR)/rc.nemesis $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXnemesis
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(NEMESIS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXnemesis
