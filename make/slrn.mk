...
#SLRN_CONFFILES=$(TARGET_PREFIX)/etc/slrn.conf $(TARGET_PREFIX)/etc/init.d/SXXslrn
...
#
# Binaries should be installed into $(SLRN_IPK_DIR)$(TARGET_PREFIX)/sbin or $(SLRN_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SLRN_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(SLRN_IPK_DIR)$(TARGET_PREFIX)/etc/slrn/...
# Documentation files should be installed in $(SLRN_IPK_DIR)$(TARGET_PREFIX)/doc/slrn/...
# Daemon startup scripts should be installed in $(SLRN_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??slrn
#
