...
#PLAN9PORT_CONFFILES=$(TARGET_PREFIX)/etc/plan9port.conf $(TARGET_PREFIX)/etc/init.d/SXXplan9port
...
#	$(MAKE) -C $(PLAN9PORT_BUILD_DIR) DESTDIR=$(PLAN9PORT_IPK_DIR) install-strip
	$(INSTALL) -d $(PLAN9PORT_IPK_DIR)$(TARGET_PREFIX)
	cp -rp $(PLAN9PORT_BUILD_DIR) $(PLAN9PORT_IPK_DIR)$(TARGET_PREFIX)/plan9
	...
	grep '^[ 	]*echo' $(PLAN9PORT_IPK_DIR)$(TARGET_PREFIX)/plan9/INSTALL | tail -4 \
		>> $(PLAN9PORT_IPK_DIR)/CONTROL/postinst
