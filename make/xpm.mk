...
#
# Binaries should be installed into $(XPM_IPK_DIR)$(TARGET_PREFIX)/sbin or $(XPM_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XPM_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(XPM_IPK_DIR)$(TARGET_PREFIX)/etc/xpm/...
# Documentation files should be installed in $(XPM_IPK_DIR)$(TARGET_PREFIX)/doc/xpm/...
# Daemon startup scripts should be installed in $(XPM_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??xpm
#
...
$(XPM_IPK): $(XPM_BUILD_DIR)/.built
	...
	rm -f $(XPM_IPK_DIR)$(TARGET_PREFIX)/lib/*.la
