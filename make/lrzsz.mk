...
#
# Binaries should be installed into $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/etc/lrzsz/...
# Documentation files should be installed in $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/doc/lrzsz/...
# Daemon startup scripts should be installed in $(LRZSZ_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??lrzsz
#
