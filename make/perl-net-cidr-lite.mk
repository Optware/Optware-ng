...
PERL-NET-CIDR-LITE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/D/DO/DOUGW
...
PERL-NET-CIDR-LITE_IPK_VERSION=3
...
$(DL_DIR)/$(PERL-NET-CIDR-LITE_SOURCE):
	$(WGET) -P $(@D) $(PERL-NET-CIDR-LITE_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-net-cidr-lite-source: $(DL_DIR)/$(PERL-NET-CIDR-LITE_SOURCE) $(PERL-NET-CIDR-LITE_PATCHES)

$(PERL-NET-CIDR-LITE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-NET-CIDR-LITE_SOURCE) $(PERL-NET-CIDR-LITE_PATCHES) make/perl-net-cidr-lite.mk
...
$(PERL-NET-CIDR-LITE_IPK): $(PERL-NET-CIDR-LITE_BUILD_DIR)/.built
	...
	find $(PERL-NET-CIDR-LITE_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
