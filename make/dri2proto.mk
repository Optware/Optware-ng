...
#
# Binaries should be installed into $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/sbin or $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/etc/dri2proto/...
# Documentation files should be installed in $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/doc/dri2proto/...
# Daemon startup scripts should be installed in $(DRI2PROTO_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??dri2proto
#
