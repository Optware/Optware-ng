...
#	$(INSTALL) -d $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib
#	$(INSTALL) -m 755 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/*.so* $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
#	$(INSTALL) -m 644 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/*.a $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
#	$(INSTALL) -m 644 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/*.o $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
#	$(INSTALL) -d $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv
#	$(INSTALL) -m 755 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/gconv/*.so $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv/
#	$(INSTALL) -m 644 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/gconv/gconv-modules $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv/
#	$(INSTALL) -d $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts
#	$(INSTALL) -m 644 $(FSG3V4_BOOTSTRAP_BUILD_DIR)/ldscripts/* $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts/
#	cd $(FSG3V4_BOOTSTRAP_BUILD_DIR) ; cp -P `find . -type l -print` $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
#	$(STRIP_COMMAND) $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/*.so

	$(INSTALL) -d $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc
	$(INSTALL) -m 755 $(IPKG-OPT_SOURCE_DIR)/rc.optware $(FSG3V4_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc
