...
PERL-CRYPT-SSLEAY_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/D/DL/DLAND
...
PERL-CRYPT-SSLEAY_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-CRYPT-SSLEAY_SOURCE):
	$(WGET) -P $(@D) $(PERL-CRYPT-SSLEAY_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-crypt-ssleay-source: $(DL_DIR)/$(PERL-CRYPT-SSLEAY_SOURCE) $(PERL-CRYPT-SSLEAY_PATCHES)

$(PERL-CRYPT-SSLEAY_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-CRYPT-SSLEAY_SOURCE) $(PERL-CRYPT-SSLEAY_PATCHES) make/perl-crypt-ssleay.mk
	$(MAKE) openssl-stage
