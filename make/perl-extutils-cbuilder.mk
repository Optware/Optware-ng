...
PERL-EXTUTILS-CBUILDER_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/K/KW/KWILLIAMS
...
PERL-EXTUTILS-CBUILDER_IPK_VERSION=4
...
$(DL_DIR)/$(PERL-EXTUTILS-CBUILDER_SOURCE):
	$(WGET) -P $(@D) $(PERL-EXTUTILS-CBUILDER_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-extutils-cbuilder-source: $(DL_DIR)/$(PERL-EXTUTILS-CBUILDER_SOURCE) $(PERL-EXTUTILS-CBUILDER_PATCHES)

$(PERL-EXTUTILS-CBUILDER_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-EXTUTILS-CBUILDER_SOURCE) $(PERL-EXTUTILS-CBUILDER_PATCHES) make/perl-extutils-cbuilder.mk
	$(MAKE) perl-stage
...
$(PERL-EXTUTILS-CBUILDER_IPK): $(PERL-EXTUTILS-CBUILDER_BUILD_DIR)/.built
	...
	find $(PERL-EXTUTILS-CBUILDER_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
