...
UNIXODBC_CONFFILES=$(TARGET_PREFIX)/etc/odbc.ini $(TARGET_PREFIX)/etc/odbcinst.ini
...
#
# Binaries should be installed into $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/sbin or $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/etc/unixodbc/...
# Documentation files should be installed in $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/doc/unixodbc/...
# Daemon startup scripts should be installed in $(UNIXODBC_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??unixodbc
#
