...
NTPCLIENT_IPK=$(BUILD_DIR)/ntpclient_$(NTPCLIENT_VERSION)-$(NTPCLIENT_IPK_VERSION)_armeb.ipk
...
$(NTPCLIENT_IPK): $(NTPCLIENT_BUILD_DIR)/ntpclient
	...
	$(STRIP) $(NTPCLIENT_BUILD_DIR)/ntpclient -o $(NTPCLIENT_IPK_DIR)/opt/bin/ntpclient
	install -d $(NTPCLIENT_IPK_DIR)/opt/sbin
	$(STRIP) $(NTPCLIENT_BUILD_DIR)/adjtimex -o $(NTPCLIENT_IPK_DIR)/opt/sbin/adjtimex
