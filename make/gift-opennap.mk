...
$(DL_DIR)/$(GIFT_OPENNAP_SOURCE):
	cd $(DL_DIR) ; $(CVS) -d $(GIFT_OPENNAP_REPOSITORY) co $(GIFT_OPENNAP_TAG) $(GIFT_OPENNAP_MODULE)
...
$(GIFT_OPENNAP_BUILD_DIR)/.configured: $(DL_DIR)/$(GIFT_OPENNAP_SOURCE) $(GIFT_OPENNAP_PATCHES)
	...
	(cd $(GIFT_OPENNAP_BUILD_DIR); \
		PKG_CONFIG_PATH="$(STAGING_DIR)/opt/lib";export PKG_CONFIG_PATH; \
		./autogen.sh; \
