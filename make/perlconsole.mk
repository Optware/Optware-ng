...
PERLCONSOLE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/S/SU/SUKRIA
...
$(DL_DIR)/$(PERLCONSOLE_SOURCE):
	$(WGET) -P $(@D) $(PERLCONSOLE_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perlconsole-source: $(DL_DIR)/$(PERLCONSOLE_SOURCE) $(PERLCONSOLE_PATCHES)

$(PERLCONSOLE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERLCONSOLE_SOURCE) $(PERLCONSOLE_PATCHES) make/perlconsole.mk
...
$(PERLCONSOLE_IPK): $(PERLCONSOLE_BUILD_DIR)/.built
	...
	(cd $(PERLCONSOLE_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
