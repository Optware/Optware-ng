...
#ETTERCAP_CONFFILES=$(TARGET_PREFIX)/etc/ettercap.conf $(TARGET_PREFIX)/etc/init.d/SXXettercap
...
#
# Binaries should be installed into $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/sbin or $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/etc/ettercap/...
# Documentation files should be installed in $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/doc/ettercap/...
# Daemon startup scripts should be installed in $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??ettercap
#
...
$(ETTERCAP_IPK): $(ETTERCAP_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(ETTERCAP_IPK_DIR)$(TARGET_PREFIX)/sbin/ettercap
