...
PERL-EXTUTILS-PARSEXS_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/K/KW/KWILLIAMS
...
PERL-EXTUTILS-PARSEXS_IPK_VERSION=3
...
$(DL_DIR)/$(PERL-EXTUTILS-PARSEXS_SOURCE):
	$(WGET) -P $(@D) $(PERL-EXTUTILS-PARSEXS_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-extutils-parsexs-source: $(DL_DIR)/$(PERL-EXTUTILS-PARSEXS_SOURCE) $(PERL-EXTUTILS-PARSEXS_PATCHES)

$(PERL-EXTUTILS-PARSEXS_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-EXTUTILS-PARSEXS_SOURCE) $(PERL-EXTUTILS-PARSEXS_PATCHES) make/perl-extutils-parsexs.mk
...
$(PERL-EXTUTILS-PARSEXS_IPK): $(PERL-EXTUTILS-PARSEXS_BUILD_DIR)/.built
	...
	find $(PERL-EXTUTILS-PARSEXS_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
