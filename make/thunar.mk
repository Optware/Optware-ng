...
THUNAR_DEPENDS=exo, pcre, gnome-icon-theme, elementary-xfce-icon-theme, elementary-xfce-dark-icon-theme, elementary-xfce-darker-icon-theme
THUNAR_SUGGESTS=
THUNAR_CONFLICTS=
