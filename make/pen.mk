...
#PEN_CONFFILES=$(TARGET_PREFIX)/etc/pen.conf $(TARGET_PREFIX)/etc/init.d/SXXpen
...
#
# Binaries should be installed into $(PEN_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PEN_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PEN_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/pen/...
# Documentation files should be installed in $(PEN_IPK_DIR)$(TARGET_PREFIX)/doc/pen/...
# Daemon startup scripts should be installed in $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??pen
#
...
$(PEN_IPK): $(PEN_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PEN_IPK_DIR)$(TARGET_PREFIX)/bin/*
#	$(INSTALL) -d $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/
#	$(INSTALL) -m 644 $(PEN_SOURCE_DIR)/pen.conf $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/pen.conf
#	$(INSTALL) -d $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/init.d
#	$(INSTALL) -m 755 $(PEN_SOURCE_DIR)/rc.pen $(PEN_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/SXXpen
