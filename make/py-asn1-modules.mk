...
#
PY-ASN1-MODULES_IPK_VERSION=1

#
# PY-ASN1-MODULES_CONFFILES should be a list of user-editable files
#PY-ASN1-MODULES_CONFFILES=/opt/etc/py-asn1-modules.conf /opt/etc/init.d/SXXpy-asn1-modules
...
#
# Binaries should be installed into $(PY-ASN1-MODULES_IPK_DIR)/opt/sbin or $(PY-ASN1-MODULES_IPK_DIR)/opt/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-ASN1-MODULES_IPK_DIR)/opt/{lib,include}
# Configuration files should be installed in $(PY-ASN1-MODULES_IPK_DIR)/opt/etc/py-asn1-modules/...
# Documentation files should be installed in $(PY-ASN1-MODULES_IPK_DIR)/opt/doc/py-asn1-modules/...
# Daemon startup scripts should be installed in $(PY-ASN1-MODULES_IPK_DIR)/opt/etc/init.d/S??py-asn1-modules
#
...
$(PY24-ASN1-MODULES_IPK): $(PY-ASN1-MODULES_BUILD_DIR)/.built
	...
	$(HOST_STAGING_PREFIX)/bin/python2.4 setup.py install --root=$(PY24-ASN1-MODULES_IPK_DIR) --prefix=/opt)
	rm -f $(PY24-ASN1-MODULES_IPK_DIR)/opt/bin/easy_install
...
$(PY25-ASN1-MODULES_IPK): $(PY-ASN1-MODULES_BUILD_DIR)/.built
	...
	$(HOST_STAGING_PREFIX)/bin/python2.5 setup.py install --root=$(PY25-ASN1-MODULES_IPK_DIR) --prefix=/opt)
	rm -f $(PY25-ASN1-MODULES_IPK_DIR)/opt/bin/easy_install
...
$(PY26-ASN1-MODULES_IPK): $(PY-ASN1-MODULES_BUILD_DIR)/.built
	...
	$(HOST_STAGING_PREFIX)/bin/python2.6 setup.py install --root=$(PY26-ASN1-MODULES_IPK_DIR) --prefix=/opt)
#	rm -f $(PY26-ASN1-MODULES_IPK_DIR)/opt/bin/easy_install
...
$(PY27-ASN1-MODULES_IPK): $(PY-ASN1-MODULES_BUILD_DIR)/.built
	...
	$(HOST_STAGING_PREFIX)/bin/python2.7 setup.py install --root=$(PY27-ASN1-MODULES_IPK_DIR) --prefix=/opt)
	rm -f $(PY27-ASN1-MODULES_IPK_DIR)/opt/bin/easy_install
...
$(PY3-ASN1-MODULES_IPK): $(PY-ASN1-MODULES_BUILD_DIR)/.built
	...
	$(HOST_STAGING_PREFIX)/bin/python$(PYTHON3_VERSION_MAJOR) setup.py install --root=$(PY3-ASN1-MODULES_IPK_DIR) --prefix=/opt)
	rm -f $(PY3-ASN1-MODULES_IPK_DIR)/opt/bin/easy_install
