...
#TS409-KERNEL-MODULES_CONFFILES=$(TARGET_PREFIX)/etc/ts409-kernel-modules.conf $(TARGET_PREFIX)/etc/init.d/SXXts409-kernel-modules
...
#	$(MAKE) -C $(TS409-KERNEL-MODULES_BUILD_DIR) $(TS409-KERNEL-MODULES-FLAGS) clean
	$(INSTALL) -m 644  $(TS409-KERNEL-MODULES_SOURCE_DIR)/kernel-2.6.21.1-ts-409.cfg $(TS409-KERNEL-MODULES_BUILD_DIR)/.config;
...
#
# Binaries should be installed into $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/sbin or $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/etc/ts409-kernel-modules/...
# Documentation files should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/doc/ts409-kernel-modules/...
# Daemon startup scripts should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??ts409-kernel-modules
#
