...
#PY-BUILDUTILS_CONFFILES=$(TARGET_PREFIX)/etc/py-buildutils.conf $(TARGET_PREFIX)/etc/init.d/SXXpy-buildutils
...
#
# Binaries should be installed into $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/sbin or $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/etc/py-buildutils/...
# Documentation files should be installed in $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/doc/py-buildutils/...
# Daemon startup scripts should be installed in $(PY-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??py-buildutils
#
...
$(PY24-BUILDUTILS_IPK): $(PY-BUILDUTILS_BUILD_DIR)/.built
	...
	(cd $(PY-BUILDUTILS_BUILD_DIR)/2.4; \
	    ...
	    --root=$(PY24-BUILDUTILS_IPK_DIR) --prefix=$(TARGET_PREFIX))
...
$(PY25-BUILDUTILS_IPK): $(PY-BUILDUTILS_BUILD_DIR)/.built
	...
	(cd $(PY-BUILDUTILS_BUILD_DIR)/2.5; \
	    ...
	    --root=$(PY25-BUILDUTILS_IPK_DIR) --prefix=$(TARGET_PREFIX))
	for f in $(PY25-BUILDUTILS_IPK_DIR)$(TARGET_PREFIX)/bin/*; \
