...
#LIBSAMPLERATE_CONFFILES=$(TARGET_PREFIX)/etc/libsamplerate.conf $(TARGET_PREFIX)/etc/init.d/SXXlibsamplerate
...
#
# Binaries should be installed into $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/sbin or $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/etc/libsamplerate/...
# Documentation files should be installed in $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/doc/libsamplerate/...
# Daemon startup scripts should be installed in $(LIBSAMPLERATE_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??libsamplerate
#
