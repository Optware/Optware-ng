...
#SQLITE_CONFFILES=$(TARGET_PREFIX)/etc/sqlite.conf $(TARGET_PREFIX)/etc/init.d/SXXsqlite
...
#
# Binaries should be installed into $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/sbin or $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/{lib,include}
# Configuration files should be installed in $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/etc/sqlite/...
# Documentation files should be installed in $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/doc/sqlite/...
# Daemon startup scripts should be installed in $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/etc/init.d/S??sqlite
#
...
$(SQLITE_IPK): $(SQLITE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/bin/sqlite3 $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/lib/*.so
	rm -f $(SQLITE_IPK_DIR)$(TARGET_PREFIX)/lib/libsqlite3.a
