...
PERL-ENCODE-DETECT_DEPENDS=libstdc++
PERL-ENCODE-DETECT_SUGGESTS=
PERL-ENCODE-DETECT_CONFLICTS=

PERL-ENCODE-DETECT_IPK_VERSION=4
...
$(PERL-ENCODE-DETECT_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-ENCODE-DETECT_SOURCE) $(PERL-ENCODE-DETECT_PATCHES) make/perl-encode-detect.mk
