...
PERL-COMPRESS-ZLIB_IPK_VERSION=5
...
$(PERL-COMPRESS-ZLIB_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-COMPRESS-ZLIB_SOURCE) $(PERL-COMPRESS-ZLIB_PATCHES) make/perl-compress-zlib.mk
