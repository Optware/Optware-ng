...
PERL-BSD-RESOURCE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/J/JH/JHI
...
PERL-BSD-RESOURCE_IPK_VERSION=3
...
$(DL_DIR)/$(PERL-BSD-RESOURCE_SOURCE):
	$(WGET) -P $(@D) $(PERL-BSD-RESOURCE_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-bsd-resource-source: $(DL_DIR)/$(PERL-BSD-RESOURCE_SOURCE) $(PERL-BSD-RESOURCE_PATCHES)

$(PERL-BSD-RESOURCE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-BSD-RESOURCE_SOURCE) $(PERL-BSD-RESOURCE_PATCHES) make/perl-bsd-resource.mk
	make perl-stage
...
$(PERL-BSD-RESOURCE_IPK): $(PERL-BSD-RESOURCE_BUILD_DIR)/.built
	...
	find $(PERL-BSD-RESOURCE_IPK_DIR)$(TARGET_PREFIX) -type d -exec chmod go+rx {} \;
