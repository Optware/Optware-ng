...
PERL-GD-BARCODE_SITE=http://$(PERL_CPAN_SITE)/CPAN/authors/id/K/KW/KWITKNR
...
$(DL_DIR)/$(PERL-GD-BARCODE_SOURCE):
	$(WGET) -P $(@D) $(PERL-GD-BARCODE_SITE)/$(@F) || \
	$(WGET) -P $(@D) $(FREEBSD_DISTFILES)/$(@F) || \
	$(WGET) -P $(@D) $(SOURCES_NLO_SITE)/$(@F)

perl-gd-barcode-source: $(DL_DIR)/$(PERL-GD-BARCODE_SOURCE) $(PERL-GD-BARCODE_PATCHES)

$(PERL-GD-BARCODE_BUILD_DIR)/.configured: $(DL_DIR)/$(PERL-GD-BARCODE_SOURCE) $(PERL-GD-BARCODE_PATCHES) make/perl-gd-barcode.mk
	$(MAKE) perl-gd-stage
...
$(PERL-GD-BARCODE_IPK): $(PERL-GD-BARCODE_BUILD_DIR)/.built
	...
	(cd $(PERL-GD-BARCODE_IPK_DIR)$(TARGET_PREFIX)/lib/perl5 ; \
