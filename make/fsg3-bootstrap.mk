...
$(FSG3_BOOTSTRAP_IPK): $(FSG3_BOOTSTRAP_BUILD_DIR)/.built
	...
	$(INSTALL) -d $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib
	$(INSTALL) -m 755 $(FSG3_BOOTSTRAP_BUILD_DIR)/*.so* $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
	$(INSTALL) -m 644 $(FSG3_BOOTSTRAP_BUILD_DIR)/*.a $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
	$(INSTALL) -m 644 $(FSG3_BOOTSTRAP_BUILD_DIR)/*.o $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/
	$(INSTALL) -d $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv
	$(INSTALL) -m 755 $(FSG3_BOOTSTRAP_BUILD_DIR)/gconv/*.so $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv/
	$(INSTALL) -m 644 $(FSG3_BOOTSTRAP_BUILD_DIR)/gconv/gconv-modules $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/gconv/
	$(INSTALL) -d $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts
	$(INSTALL) -m 644 $(FSG3_BOOTSTRAP_BUILD_DIR)/ldscripts/* $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/ldscripts/
	cd $(FSG3_BOOTSTRAP_BUILD_DIR) ; cp -P `find . -type l -print` $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/

	$(INSTALL) -d $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc
	$(INSTALL) -m 755 $(IPKG-OPT_SOURCE_DIR)/rc.optware $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/etc
...
#	$(STRIP_COMMAND) $(FSG3_BOOTSTRAP_IPK_DIR)$(TARGET_PREFIX)/lib/*.so
