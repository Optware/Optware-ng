...
LIBGO_TARGET_LIBDIR = $(TARGET_CROSS_TOP)/arm-buildroot-linux-uclibcgnueabi/lib
...
$(BUILDROOT-ARMEABI-NG_SOURCE_DIR)/toolchain-gccgo.patch \
$(BUILDROOT-ARMEABI-NG_SOURCE_DIR)/uclibc-ng-bump.patch \

BUILDROOT-ARMEABI-NG_UCLIBC-NG_PATCHES=\
$(wildcard $(BUILDROOT-ARMEABI-NG_SOURCE_DIR)/uclibc-ng-patches/*.patch)

BUILDROOT-ARMEABI-NG_GCC_PATCHES=\
$(wildcard $(BUILDROOT-ARMEABI-NG_SOURCE_DIR)/gcc-patches/$(CROSS_CONFIGURATION_GCC_VERSION)/*.patch)
...
ifneq ($(BUILDROOT-ARMEABI-NG_UCLIBC-NG_PATCHES), )
	$(INSTALL) -m 644 $(BUILDROOT-ARMEABI-NG_UCLIBC-NG_PATCHES) $(TARGET_CROSS_BUILD_DIR)/package/uclibc
endif
ifneq ($(BUILDROOT-ARMEABI-NG_GCC_PATCHES), )
	$(INSTALL) -m 644 $(BUILDROOT-ARMEABI-NG_GCC_PATCHES) \
