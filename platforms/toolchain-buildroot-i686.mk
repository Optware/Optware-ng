...
$(BUILDROOT-I686_SOURCE_DIR)/toolchain-gccgo.patch \

BUILDROOT-I686_GCC_PATCHES=\
$(wildcard $(BUILDROOT-I686_SOURCE_DIR)/gcc-patches/$(CROSS_CONFIGURATION_GCC_VERSION)/*.patch)

BUILDROOT-I686_GLIBC_PATCHES=\
$(wildcard $(BUILDROOT-I686_SOURCE_DIR)/glibc-patches/*.patch)
...
$(TARGET_CROSS_TOP)/.configured: $(DL_DIR)/$(TOOLCHAIN_SOURCE) \
				$(BUILDROOT-I686_SOURCE_DIR)/config \
				$(BUILDROOT-I686_PATCHES) \
				$(BUILDROOT-I686_GCC_PATCHES) \
				$(BUILDROOT-I686_GLIBC_PATCHES) \
...
ifneq ($(BUILDROOT-I686_GCC_PATCHES), )
	$(INSTALL) -m 644 $(BUILDROOT-I686_GCC_PATCHES) \
		$(TARGET_CROSS_BUILD_DIR)/package/gcc/$(CROSS_CONFIGURATION_GCC_VERSION)
endif
ifneq ($(BUILDROOT-I686_GLIBC_PATCHES), )
	$(INSTALL) -m 644 $(BUILDROOT-I686_GLIBC_PATCHES) \
...
$(TARGET_CROSS_TOP)/.built: $(TARGET_CROSS_TOP)/.configured
	...
	ln -sf i686-buildroot-linux-gnu-gccgo $(TARGET_CROSS_TOP)/bin/gccgo
	...
	cp -af  $(TARGET_CROSS_TOP)/i686-buildroot-linux-gnu/sysroot/lib/* \
		$(TARGET_CROSS_TOP)/lib/gcc/i686-buildroot-linux-gnu/7.2.0/*.a $(GLIBC-OPT_LIBS_SOURCE_DIR)/
	touch $@
