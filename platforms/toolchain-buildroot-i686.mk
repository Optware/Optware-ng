...
TARGET_CROSS_TOP = $(BASE_DIR)/toolchain/buildroot-i686-linux-3.2.66-glibc-5.2.0
...
$(TARGET_CROSS_TOP)/.built: $(TARGET_CROSS_TOP)/.configured
	...
	cp -f $(TARGET_CROSS_TOP)/lib/gcc/i686-buildroot-linux-gnu/5.2.0/*.a $(GLIBC-OPT_LIBS_SOURCE_DIR)/
	touch $@
