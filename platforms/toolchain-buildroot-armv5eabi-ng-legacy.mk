...
$(wildcard $(BUILDROOT-ARMv5EABI-NG-LEGACY_SOURCE_DIR)/linux-patches/*.patch)

BUILDROOT-ARMv5EABI-NG-LEGACY_GCC_PATCHES=\
$(wildcard $(BUILDROOT-ARMv5EABI-NG-LEGACY_SOURCE_DIR)/gcc-patches/$(CROSS_CONFIGURATION_GCC_VERSION)/*.patch)
...
ifneq ($(BUILDROOT-ARMv5EABI-NG-LEGACY_GCC_PATCHES), )
