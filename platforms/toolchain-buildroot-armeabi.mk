...
TARGET_CROSS_TOP = $(BASE_DIR)/toolchain/buildroot-arm-linux-2.6.36-uclibc-5.2.0
...
$(TARGET_CROSS_TOP)/.configured: $(DL_DIR)/$(TOOLCHAIN_SOURCE) #$(OPTWARE_TOP)/platforms/toolchain-$(OPTWARE_TARGET).mk
	...
	cp -f $(BUILDROOT-ARMEABI_SOURCE_DIR)/uclibc.config $(TARGET_CROSS_BUILD_DIR)/package/uclibc/my.uclibc.config
