...
PY-MARKDOWN-COMMON_IPK_DIR=$(BUILD_DIR)/py-markdown-common-$(PY-MARKDOWN_VERSION)-ipk
PY-MARKDOWN-COMMON_IPK=$(BUILD_DIR)/py-markdown-common_$(PY-MARKDOWN_VERSION)-$(PY-MARKDOWN_IPK_VERSION)_$(TARGET_ARCH).ipk
...
$(PY25-MARKDOWN_IPK) $(PY-MARKDOWN-COMMON_IPK): $(PY-MARKDOWN_BUILD_DIR)/.built
	rm -rf $(PY25-MARKDOWN_IPK_DIR) $(BUILD_DIR)/py25-markdown_*_$(TARGET_ARCH).ipk
	rm -rf $(PY-MARKDOWN-COMMON_IPK_DIR) $(BUILD_DIR)/py-markdown*_*_$(TARGET_ARCH).ipk
