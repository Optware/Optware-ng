...
CROSSTOOL-PREFIX=/opt/$(GNU_TARGET_NAME)/$(CROSS_CONFIGURATION)
...
$(CROSSTOOL-NATIVE_BUILD_DIR)/.built: $(CROSSTOOL-NATIVE_BUILD_DIR)/.configured
	...
	rm -rf $(CROSSTOOL-NATIVE_BUILD_DIR)$(CROSSTOOL_PREFIX)
	mkdir -p $(CROSSTOOL-NATIVE_BUILD_DIR)$(CROSSTOOL_PREFIX)
	$(SUDO) rm -rf $(CROSSTOOL_PREFIX)
	$(SUDO)	mkdir -p /opt/$(GNU_TARGET_NAME)
	$(SUDO) ln -s $(CROSSTOOL-NATIVE_BUILD_DIR)$(CROSSTOOL_PREFIX) \
		$(CROSSTOOL_PREFIX)
...
$(CROSSTOOL-NATIVE_IPK): $(CROSSTOOL-NATIVE_BUILD_DIR)/.built
	...
	install -d $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)
	( cd $(CROSSTOOL_PREFIX) ; tar cf - . ) | \
		( cd $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX) ; tar xvf - )
...
# /lib/cpp is usually required
	...
	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-cpp /lib/cpp
	install -d $(CROSSTOOL-NATIVE_IPK_DIR)/opt/bin
# The following links should not be required
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-ar /opt/bin/ar
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-as /opt/bin/as
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-c++ /opt/bin/c++
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-cpp /opt/bin/cpp
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-g++ /opt/bin/g++
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-gcc /opt/bin/gcc
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-ld /opt/bin/ld
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-nm /opt/bin/nm
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-ranlib /opt/bin/ranlib
# 	ln -s $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL_PREFIX)/bin/$(GNU_TARGET_NAME)-strip /opt/bin/strip
