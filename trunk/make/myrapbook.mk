...
MYRAPBOOK_DESCRIPTION=A daemon originally written for WD's My Book World disk drives, that implements a downloader for rapidshare.com premium users. Is based on libcurl and runs multiple threads for downloading multiple files. The daemon is controlled remotelly from any web browser.
...
#MYRAPBOOK_CONFFILES=/opt/etc/myrapbook.conf /opt/etc/init.d/SXXmyrapbook
...
#	install -m 755 $(MYRAPBOOK_SOURCE_DIR)/rc.myrapbook $(MYRAPBOOK_IPK_DIR)/opt/etc/init.d/SXXmyrapbook
