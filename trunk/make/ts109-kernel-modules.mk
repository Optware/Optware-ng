...
TS109-KERNEL-MODULES_DESCRIPTION=TS-209 kernel modules
TS109-KERNEL-IMAGE_DESCRIPTION=TS-209 kernel
...
$(TS109-KERNEL-MODULES_BUILD_DIR)/.built: $(TS109-KERNEL-MODULES_BUILD_DIR)/.configured \
		$(TS109-KERNEL-MODULES_SOURCE_DIR)/qnap_ts-209.cfg make/ts109-kernel-modules.mk
	rm -f $(TS109-KERNEL-MODULES_BUILD_DIR)/.built
#	$(MAKE) -C $(TS109-KERNEL-MODULES_BUILD_DIR) $(TS109-KERNEL-MODULES-FLAGS) clean
	cp  $(TS109-KERNEL-MODULES_SOURCE_DIR)/qnap_ts-209.cfg $(TS109-KERNEL-MODULES_BUILD_DIR)/.config;
