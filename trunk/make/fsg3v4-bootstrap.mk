...
FSG3V4_BOOTSTRAP_IPK_VERSION=1
...
FSG3V4_OPENSSL_IPK=openssl_0.9.7?-?_$(TARGET_ARCH).ipk
FSG3V4_WGET_SSL_IPK=wget-ssl_1.10.2-?_$(TARGET_ARCH).ipk
...
$(FSG3V4_BOOTSTRAP_XSH): $(FSG3V4_BOOTSTRAP_IPK) openssl-ipk wget-ssl-ipk
	...
	cp $(BUILD_DIR)/$(FSG3V4_OPENSSL_IPK) $(FSG3V4_BOOTSTRAP_BUILD_DIR)/bootstrap/openssl.ipk
	cp $(BUILD_DIR)/$(FSG3V4_WGET_SSL_IPK) $(FSG3V4_BOOTSTRAP_BUILD_DIR)/bootstrap/wget-ssl.ipk
