...
UNSLUNG-DEVEL_DEPENDS=ncurses, bash, bison, coreutils, findutils, flex, gawk, libstdc++, groff, libtool, make, m4, autoconf, automake, patch, perl, sed, bzip2, tar, openssl, wget-ssl, crosstool
UNSLUNG-DEVEL_SUGGESTS=
UNSLUNG-DEVEL_CONFLICTS=

UNSLUNG-DEVEL_IPK_VERSION=1
