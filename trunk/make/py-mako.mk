...
#
py-mako-ipk: $(PY24-MAKO_IPK) $(PY25-MAKO_IPK)
...
#
py-mako-check: $(PY24-MAKO_IPK) $(PY25-MAKO_IPK)
	perl scripts/optware-check-package.pl --target=$(OPTWARE_TARGET) $(PY24-MAKO_IPK) $(PY25-MAKO_IPK)
