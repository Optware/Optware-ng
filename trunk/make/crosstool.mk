...
#
CROSSTOOL_BUILD_DIR=$(BUILD_DIR)/crosstool
...
$(CROSSTOOL_BUILD_DIR)/.configured: $(DL_DIR)/$(CROSSTOOL_SOURCE) $(CROSSTOOL_PATCHES)
	rm -rf $(BUILD_DIR)/$(CROSSTOOL_DIR) $(CROSSTOOL_BUILD_DIR)
	$(CROSSTOOL_UNZIP) $(DL_DIR)/$(CROSSTOOL_SOURCE) | tar -C $(BUILD_DIR) -xvf -
#	cat $(CROSSTOOL_PATCHES) | patch -d $(BUILD_DIR)/$(CROSSTOOL_DIR) -p1
	mv $(BUILD_DIR)/$(CROSSTOOL_DIR) $(CROSSTOOL_BUILD_DIR)
