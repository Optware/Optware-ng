...
#BZR-REWRITE_CONFFILES=/opt/etc/bzr-rewrite.conf /opt/etc/init.d/SXXbzr-rewrite
...
#
# Binaries should be installed into $(BZR-REWRITE_IPK_DIR)/opt/sbin or $(BZR-REWRITE_IPK_DIR)/opt/bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BZR-REWRITE_IPK_DIR)/opt/{lib,include}
# Configuration files should be installed in $(BZR-REWRITE_IPK_DIR)/opt/etc/bzr-rewrite/...
# Documentation files should be installed in $(BZR-REWRITE_IPK_DIR)/opt/doc/bzr-rewrite/...
# Daemon startup scripts should be installed in $(BZR-REWRITE_IPK_DIR)/opt/etc/init.d/S??bzr-rewrite
#
...
#	$(STRIP_COMMAND) $(PY26-BZR-REWRITE_IPK_DIR)/opt/lib/python2.6/site-packages/bzrlib/*.so
