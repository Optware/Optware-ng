...
CROSS_CONFIGURATION_GCC_VERSION=4.2.2
...
GNU_TARGET_NAME = arm-angstrom-linux-gnueabi
TARGET_CROSS_TOOLCHAIN_LOCATION=angstrom/tmp
TARGET_CROSS_TOP = $(shell cd $(BASE_DIR)/../..; pwd)/$(TARGET_CROSS_TOOLCHAIN_LOCATION)
TARGET_CROSS = $(TARGET_CROSS_TOP)/cross/bin/$(GNU_TARGET_NAME)-
TARGET_LIBDIR = $(TARGET_CROSS_TOP)/staging/$(GNU_TARGET_NAME)/lib
TARGET_INCDIR = $(TARGET_CROSS_TOP)/staging/$(GNU_TARGET_NAME)/include
TARGET_LDFLAGS = 
